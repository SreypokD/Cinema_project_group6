        ...
        <div class="w-9/12">
            ...
            <div class="flex justify-end mt-4">
                ...
                <a href="/delete?id=<?php echo $movie['movie_id'];?>">
                    <svg class="delete w-8 h-8 text-red-500 font-bold cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" " >
