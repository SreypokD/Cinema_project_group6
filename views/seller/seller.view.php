...
<div class="mx-28 mt-2" >
    ...
    <div class="flex justify-between items-center border-b-2 border-white mt-2 bg-gray-900 rounded-xl hover:bg-gray-800">
        ...
        <div class="flex justify-end mt-4">
                <a href="/show">
                    <!-- <svg class= "mr-2 w-8 h-8 text-blue-600 font-bold cursor-pointer" value="<?php echo $item['movie_id']; ?>" name="edit" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" ">
                ...
                <a href="/delete?id=<?php echo $movie['movie_id'];?>">
                    <!-- <svg class="mr-2 w-8 h-8 text-red-600 font-bold cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" " >
