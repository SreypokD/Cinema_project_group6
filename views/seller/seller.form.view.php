...
<div class="mx-96 mt-8">
    <form action="<?php echo $action?>" class="bg-black shadow-md rounded px-8 pt-6 pb-8 mb-4" method="post">
        <p class="text-center text-red-700 text-lg font-bold">CREATE MOVIE</p>
            ...
            <div class="mb-4 text-red-700">             
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Movie Duration" name="duration" value="<?php echo ($item?$item['duration']:$item) ?>">
            </div>
            <div class="mb-4">
                ...
                <div class="relative max-w-sm">
                    ...
                    <input datepicker type="text" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date" id="date" name="releastDate" value="<?php echo ($item?$item['releast_date']:$item) ?>">
                </div>
            </div>
            <div class="mb-4">
                <label class="block text-red-700" for="picture">Image</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Image URL" name="picture" value="<?php echo ($item?$item['picture']:$item) ?>">
            </div>
            <div class="mb-4">
                <label class="block text-red-700" for="image">Start Date</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Input Movie Start Date" name="start_date" value="<?php echo ($item?$item['start_date']:$item) ?>">
            </div>
            <div class="mb-4">
                <label class="block text-red-700" for="image">End Date</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Input Movie End Date" name="end_date" value="<?php echo ($item?$item['end_date']:$item) ?>">
            </div>
            <div class="mb-4">
                <label class="block text-red-700" for="image">Format</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Input Format(Ex: 2D,..)" name="format" value="<?php echo ($item?$item['format']:$item) ?>">
            </div>
