...
?>
                ...
                <div class="absolute opacity-0 fd-sh group-hover:opacity-100 group-hover:buttom-0">
                    ...
                    <button class="text-white p-2 bg-red-700  text-white font-bold text-sm w-30 rounded-md hover:bg-black transition-all"><a href="/detail?id=<?php echo $movie['movie_id'] ?>">SEE MORE</a></button>
                    <button class="text-white p-2 bg-red-700  text-white font-bold text-sm w-30 mt-5 rounded-md hover:bg-black transition-all"><a href="https://majorcineplex.com.kh/home">BUY NOW</a></button>
                </div>
                </div>
                </div>
