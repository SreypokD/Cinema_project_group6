...
<div class="flex justify-evenly mb-10 grid grid-cols-4 gap-4">
        ...
        <div class="bg-red-500 p-3 flex flex-col justify-center mt-10" id="card">  
          <div class=" max-w-sm flex justify-center items-center content-div rounded-md">
              <img src="../../asset/image/mm.jpg" alt="" class="ml-8 rounded-md" id="img">       
                  <div></div>
              <div>
              ...
              <div class="absolute opacity-0 fd-sh group-hover:opacity-100 group-hover:buttom-0">
                 ...
                 <button class="text-white p-2 bg-red-600  text-white font-bold text-sm w-30 rounded-md"><a href="https://www.w3schools.com/">SEE MORE</a></button>
              ...
              <div class="flex justify-end">
                  <p class="text-white text-xl mb-5 font-medium" id="p">hello</p>
              </div>
          </div>
