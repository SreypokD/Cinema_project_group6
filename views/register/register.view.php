<?php require "views/partials/head.php" ?>
  ...
  <div class="bg-white border-t-4 border-b-4 border-red-600 rounded-b text-red-900 px-4 py-2 shadow-md mb-5"  role="alert">
    <div class="inline-flex items-center ml-48">
  ...
  <div class="grid md:grid-cols-2 md:gap-6">
    <div class="relative z-0 w-full mb-6 group">
      ...
      <label for="first_name" class="pl-6 peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-white peer-focus:dark:text-white peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">First name</label>
        ...
        <span class="text-red-600 text-sm"><?php echo isset($errors['first_name'])? $errors['first_name'] : "" ?></span>
    ...
    <div class="relative z-0 w-full mb-6 group">
      ...
      <span class="text-red-600 text-sm"><?php echo isset($errors['last_name'])? $errors['last_name'] : "" ?></span>
  ...
  <div class="relative z-0 w-full mb-6 group">
    ...
    <span class="text-red-600 text-sm"><?php echo isset($errors['email'])? $errors['email'] : "" ?></span>
  </div>
  ...
  <div class="relative z-0 w-full mb-6 group">
    ...
    <span class="text-red-600 text-sm"><?php echo isset($errors['password'])? $errors['password'] : "" ?></span>
  ...
  <div class="relative z-0 w-full mb-6 group">
    ...
    <span class="text-red-600 text-sm"><?php echo isset($errors['verify_pass'])? $errors['verify_pass'] : "" ?></span>
  </div>
