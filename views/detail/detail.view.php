        ...
        <div class="flex mb-8">
          <div class="grid w-full grid-cols-4 sm:grid-cols-6">
            <div class="aspect-w-2 aspect-h-3 overflow-hidden rounded-lg bg-gray-100 sm:col-span-4 lg:col-span-5">
              <img src="https://pbs.twimg.com/media/FkKORoyUcAErPlB.jpg:large" class="object-cover object-center">
            </div>
          </div>
          <div class="w-3/4  h-full leading-10 flex flex-col text-xl">
            <div class="w-full text-white">
              <p>Language <span>     : Khmer</span></p>
            </div>
            <div class="w-full text-white">
              <p>Subtitle <span>     : English</span></p>
            </div>
            <div class="w-full text-white">
              <p>Formats <span>      : 3D</span></p>
            </div>
            <div class="w-full text-white">
              <p>Classification <span>     : NC15</span></p>
            </div>
            <div class="w-full text-white">
              <p>Running Time <span>     : 190 Minutes</span></p>
            </div>
            <div class="w-full text-white">
              <p>Start-date: 16-Jan-2023</p>
            </div>
            <div class="w-full text-white">
              <p>End-date: 01-Feb-2023</p>
            </div>
          </div>
