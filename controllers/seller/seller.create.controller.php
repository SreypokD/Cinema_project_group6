...
if(empty($id)){
    ...
    if (empty($massageEorror['title']) && empty($massageEorror['subtitle']) && empty($massageEorror['endDate']) && empty($massageEorror['startDate']) && empty($massageEorror['releastDate']) && empty($massageEorror['picture'])  && empty($massageEorror['duration']) && empty($massageEorror['description'])){
